...
class EmployeeAttendanceTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        onSecondary: EmployeeAttendanceAppColor.textColor,
      ),
      useMaterial3: true,
      ...
      //   side: BorderSide(
      //     color: QuranColor.primaryColorLight.withValues(alpha: 0.3),
      //     width: 2,
      //   ),
      ...
      //   color: const Color(0xff614730).withValues(alpha: 0.9),
      //   thickness: 1,
      //   space: 0,
      // ),
      ...
      //   selectionColor:
      //       QuranColor.primaryColorLight.withValues(alpha: 0.2),
      ...
      //     bodySmall: TextStyle(
      //       color: QuranColor.textColorLight.withValues(alpha: 0.6),
      //       fontFamily: FontFamily.inter,
  ...
  //   checkboxTheme: CheckboxThemeData(
  //     side: BorderSide(
  //       color: QuranColor.textColorDark.withValues(alpha: 0.3),
  //       width: 2,
  //     ),
  //     shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4.5)),
  //   ),
  ...
  //     selectionColor: QuranColor.textColorDark.withValues(alpha: 0.5),
  ...
  //       bodySmall: TextStyle(
  //         color: QuranColor.textColorDark.withValues(alpha: 0.6),
  //         fontFamily: FontFamily.inter,
  //         fontWeight: FontWeight.w400,
  //       ),
