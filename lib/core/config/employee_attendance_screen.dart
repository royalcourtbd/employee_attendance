...
///
/// The `EmployeeAttendanceScreen` class provides static methods and properties to access
...
///
/// ```dart
/// EmployeeAttendanceScreen.setUp();
/// double screenWidth = EmployeeAttendanceScreen.width;
/// double screenHeight = EmployeeAttendanceScreen.height;
/// ```
///
/// Rationale:
///
/// - The `EmployeeAttendanceScreen` class provides a convenient way to access the screen dimensions
...
/// the `EmployeeAttendanceScreen` class benefits from its reliability and compatibility with different
...
class EmployeeAttendanceScreen {
  EmployeeAttendanceScreen._();
  ...
  static Size get _size => MediaQuery.sizeOf(EmployeeAttendance.globalContext);
  ...
  static void _resetIfInvalid() {
    if (_width! < 10 || _height! < 10) {
      logErrorStatic(
        'EmployeeAttendanceScreen size not initialized. Please initialize EmployeeAttendanceScreen and try again.',
        "Tutor_screen",
      );
      _width = null;
      _height = null;
...
extension EmployeeAttendanceScreenWidth on Widget {
  static double? _onePercentWidth;

  double get onePercentWidth {
    const double onePercent = 0.01;
    _onePercentWidth ??= EmployeeAttendanceScreen.width * onePercent;
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= EmployeeAttendanceScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= EmployeeAttendanceScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= EmployeeAttendanceScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= EmployeeAttendanceScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= EmployeeAttendanceScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= EmployeeAttendanceScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= EmployeeAttendanceScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= EmployeeAttendanceScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= EmployeeAttendanceScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= EmployeeAttendanceScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??=
        EmployeeAttendanceScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= EmployeeAttendanceScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??=
        EmployeeAttendanceScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??=
        EmployeeAttendanceScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??=
        EmployeeAttendanceScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= EmployeeAttendanceScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= EmployeeAttendanceScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= EmployeeAttendanceScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= EmployeeAttendanceScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??=
        EmployeeAttendanceScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??=
        EmployeeAttendanceScreen.height * tweentyPercentHeight;
...
double? employeeAttendanceScreenWidthQuarterPercentage;
...
/// `_widthPercent`, and `_EmployeeAttendanceScreenWidthQuarterPercentage`), subsequent conversions for the same
...
extension DeviceExt on num {
  ...
  /// `_calculateEmployeeAttendanceScreenWidthQuarterPercentage` function.
  ///
  ///
  /// Example usage:
  ///
  ...
  /// ```
  double get px {
    employeeAttendanceScreenWidthQuarterPercentage ??=
        _calculateEmployeeAttendanceScreenWidthQuarterPercentage();
    return this * (employeeAttendanceScreenWidthQuarterPercentage ?? 0);
  }
  ...
  double get percentHeight {
    _heightPercent ??= EmployeeAttendanceScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= EmployeeAttendanceScreen.width / 100;
...
///
/// The `_calculateEmployeeAttendanceScreenWidthQuarterPercentage` function calculates and returns
...
///
/// This function assumes that the `EmployeeAttendanceScreen` class, containing the width property,
/// is properly defined and accessible within the scope of this function.
double _calculateEmployeeAttendanceScreenWidthQuarterPercentage() {
  return (EmployeeAttendanceScreen.width / 3.9) / 100;
}
